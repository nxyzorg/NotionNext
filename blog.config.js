...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '历程.ME', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个顶级干饭人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://licheng.me', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '历程.ME, 博客', // 网站关键词 英文逗号隔开
